...
<Cards>
  <Card title="Providers" href="/plugins/providers" image>
    <div className="p-4">
      Add provider plugins to handle callbacks
    </div>
  </Card>

  <Card title="Session" href="/plugins/session" image>
    <div className="p-4">
      Add session plugins to handle encoding/decoding
    </div>
  </Card>

  <Card title="Utilities" href="/plugins/utilities" image>
    <div className="p-4">
      Add utility plugins to handle other requests
    </div>
  </Card>
</Cards>

[Plugin API reference](/reference/plugins)

## Integrate with backend

<Cards>
  <Card title="SvelteKit" href="/integrations/sveltekit" image>
    <div className="p-4">
      SvelteKit image
    </div>
  </Card>

  <Card title="Express.js" href="/integrations/express" iamge>
    <div className="p-4">
      Express.js image
    </div>
  </Card>
