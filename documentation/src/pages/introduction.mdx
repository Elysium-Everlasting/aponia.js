...
const provider1 = new OAuthProvider({ id: 'provider1' })

const provider2 = new OIDCProvider({ id: 'provider2' })
...
```ts filename="src/auth/github.ts"
...
<Callout type="info">
  ...
  [Read more about the core provider plugin](/plugins/providers/core)

  [Read more about the auth.js integration](/plugins/providers/auth)
</Callout>
