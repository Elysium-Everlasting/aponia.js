...
type PrismaClient = { $transaction: (...args: any) => any } & Record<string, any>
...
export const transformPrismaSession = (sessionData: PrismaSession): SessionSchema => {
...
export type SmartPrismaModel<_Schema = any> = {
  findUnique: <_Included = any>(options: {
